...
-- =========================
-- Sales (line-level transactions)
-- total_amount is generated as (quantity * unit_price)
-- =========================
...
INSERT INTO payment_methods (id, method_name, active_)
VALUES ('011','online','yes'),('012','cash','no'),('013','online','yes');
INSERT INTO sales_channels (id,channel_name,active_)
VALUES ('001','abc','yes'),('002','def','yes'),('003','ghi','no');
